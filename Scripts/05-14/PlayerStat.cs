...
public class PlayerStat : NetworkBehaviour
{
    ...
    {        
        ...
        {
            money -= price;
            TargetGiveItem(connectionToClient, itemType);
        }
    }
    ...
    [TargetRpc]
    public void TargetGiveItem(NetworkConnection target, ItemType itemType)
    {
        ...
        InventoryManager.Instance.RegisterItemSlot(copy.GetComponent<Item>());
    }
